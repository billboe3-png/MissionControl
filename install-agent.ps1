...
& "$pyDir\python.exe" -m pip install --quiet httpx psutil pydantic pydantic-settings pyyaml packaging 2>$null
...
& "$pyDir\python.exe" -m pip install --quiet --no-deps -e . 2>$null
Pop-Location
